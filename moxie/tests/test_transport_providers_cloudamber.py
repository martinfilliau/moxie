...
class CloudAmberBusRtiProviderTestCase(unittest.TestCase):
    ...
    def setUp(self):
        self.html_test_file_info = 'moxie/tests/data/cloudamber-info.html'
        self.html_test_file_messages = 'moxie/tests/data/cloudamber-messages.html'
    ...
    def test_messages(self):
        ...
        provider = CloudAmberBusRtiProvider('foo.bar')
        services, messages = provider.parse_html(content)
        #self.assertEqual(messages[0], message)     TODO escape char problem
